...
render = (array) => {
  ...
  array.forEach((sv) => {
    ...
    <tr>
        ...
        <th>${sv.diemTrungBinh}</th>
        <th>
        <button class="btn btn-danger rounded">Xóa</button>
        <button class="btn btn-success rounded" onclick="xoaSinhVien(array, sv.maSinhVien)">Chỉnh sửa</button>
        </th>
    </tr>
    `;
  });
