...
editSinhVien = (maSV) => {
  ...
  if (indexEdit !== -1) {
    document.querySelector("#maSinhVien").value =sinhVien[indexEdit].maSinhVien;
    document.querySelector("#tenSinhVien").value =sinhVien[indexEdit].tenSinhVien;
    document.querySelector("#loaiSinhVien").value =sinhVien[indexEdit].loaiSinhVien;
    document.querySelector("#email").value = sinhVien[indexEdit].email;
    document.querySelector("#soDienThoai").value =sinhVien[indexEdit].soDienThoai;
    ...
    document.querySelector("#diemRenLuyen").value =sinhVien[indexEdit].diemRenLuyen;
...
document.querySelector("#btnLuu").onclick = function () {
  ...
  sinhVienEdit.soDienThoai = document.querySelector("#soDienThoai").value;
    ...
    sinhVien.forEach((key, index) => {
      if (+key.maSinhVien === sinhVienEdit.maSinhVien) indexSave = index;
    }) 
};
